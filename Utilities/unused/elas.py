...
#ECRS="/home/akm26/Documents/Juneau/ASTER/L14/NewVerticalCoregistration/juneau_ecrs_new_ice_only_surfaced.grd";
ECRS="/home/akm26/Documents/Juneau/ELAs/juneau_ecrs_new_ice_only_pxnr_surfaced.grd";
...
while 1:
 ...
 cmd+="\ngrdsample "+ECRS+" -R"+glacier+"_Glacier_SRTM.grd -Qn -F -G"+glacier+"_Glacier_ECR.grd\n";
 subprocess.call(cmd,shell=True);
 ...
 cmd+="\ngrdmath "+glacier+"_Glacier_ECR.grd "+glacier+"_Glacier_SRTM_Ablation.grd OR = "+glacier+"_Glacier_ECR_Ablation.grd\n";
 cmd+="\ngrdmath "+glacier+"_Glacier_ECR.grd "+glacier+"_Glacier_SRTM_Accumulation.grd OR = "+glacier+"_Glacier_ECR_Accumulation.grd\n";
 cmd+="\nmakecpt -Cpanoply -I -T-10/10/1 > ecr.cpt\n";
 cmd+="\ngrdimage "+glacier+"_Glacier_ECR_Ablation.grd -Jx1:300000 -Cecr.cpt "+R+" -Q -P > "+glacier+"_Glacier_ECR_Ablation.ps\n";
 cmd+="\ngrdimage "+glacier+"_Glacier_ECR_Accumulation.grd -Jx1:300000 -Cecr.cpt "+R+" -Q -P > "+glacier+"_Glacier_ECR_Accumulation.ps\n";
 cmd+="\nps2raster -A -Tf "+glacier+"_Glacier_ECR_Ablation.ps\n";
 cmd+="\nps2raster -A -Tf "+glacier+"_Glacier_ECR_Accumulation.ps\n";
 cmd+="\nrm "+glacier+"_Glacier_ECR_Ablation.ps "+glacier+"_Glacier_ECR_Accumulation.ps\n";
 subprocess.call(cmd,shell=True);
