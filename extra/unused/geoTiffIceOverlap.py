...
def geoTiffOverlap(input1_tif_path, input2_tif_path, ice_bounds_path, output_res, umt_zone, input_nodata_val, area_threshold):
	...
	cmd += "\ngrdmask " + ice_bounds_path + " -Gmask.grd -NNaN/NaN/1 -Rtemp.grd\n";
	cmd += "\ngrdmath temp.grd mask.grd OR = temp2.grd\n";
	subprocess.call(cmd,shell=True);
