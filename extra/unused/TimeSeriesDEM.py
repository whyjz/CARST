# TimeSeriesDEM is the predecessor of DemPile. 
# It is a subclass of np.ndarray, but when the reference area is much bigger than the extent of each DEM,
# This method will take huge unnecessary memory space.
